...
def createJigsaw():
    ...
    for row in range(totalRows):
        ...
        for col in range(totalColumns):
            ...
            # turtle.window_width() is for x
            # turtle.window_height() is for y
            ...
            newTurtle.goto(xpos,ypos)
            # Build the image file name
            # row as variable, col as variable
...
def checkJigsaw():
    ...
    turtle.clear()
    if checkResult:
        tutle.write("Congratulations! Your jigsaw is correct!",font=("Arial", 25,"bold"))
    else:
        turtle.write("Oh no! Your jigsaw is WRONG!!",font=("Arial", 25,"bold"))
