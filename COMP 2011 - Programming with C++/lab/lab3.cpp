...
//define isExist function
bool isExist(int student_id)
{
    ifstream ifs;
...
void insert_student(int student_id){
    ...
    else
    {
        ...
        {
            int line;
            bool temp = 1;   //student_id has not been inserted
            while(ifs >> line)
            {
                if(line < student_id)
                {
                ...
                else if ((line > student_id) && (temp != 0) )
                {
                    ofs << student_id << endl;
                    ofs << line << endl;
                    temp = 0;   //student_id has been inserted
                }
                else
                {
                    ofs << line << endl;
