...
int main()
{
    ...
    */
    ...
    for(int i = numOfDigits; i > 0; i--)    //abcd bcd cd d
    {
        int divider;
        divider = pow(10,i);
        int longSubString = inputNumber % divider;
        // cout << longSubString << endl;   //testing code
        for (int j = 0; j < i; j++)
        {
            int subString = longSubString/(pow(10,j));
            //cout << "///" << subString << endl;  //testing code
