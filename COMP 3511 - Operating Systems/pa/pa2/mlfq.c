...
void mlfq() {
    ...
    for(int j=0; j < total_burst_time;j++)
    {
        ...
        if(index_arrive < process_table_size && process_table[index_arrive].arrival_time <= j)
        {
            // enqueue tq0
        ...
        if(tq0_queue[0] != NULL)
        {
            ...
            // printf("%s ",tq0_queue[0]->name);
            // printf("%d ",tq0_queue[0]->burst_time);
            // printf("%d ",tq0_queue[0]->remain_time);
            // printf("tq0\n");
        ...
        else if(tq1_queue[0] != NULL)
        {
            ...
            // printf("%s ",tq1_queue[0]->name);
            // printf("%d ",tq1_queue[0]->burst_time);
            // printf("%d ",tq1_queue[0]->remain_time);
            // printf("tq1\n");
            ...
            if(tq1_queue[0]->remain_time == 0)
            {
                if(tq1_queue[0]->burst_time > 0)
                {
                    ...
                    fcfs_queue[num_fcfs] = tq1_queue[0];
                    num_fcfs++;
                }
                //dequeue tq1
                // printf("%d\n ",num_tq1);
               ...
               for(int i=0;i < num_tq1; i++)
                ...
                // for(int i=0 ;i < MAX_NUM_PROCESS;i++)
                // {
                //     if(tq1_queue[i] == NULL) printf("NULL\n");
                //     else printf("%d\n",num_tq1);
                // }
        ...
        else
        {
            ...
            // printf("%s ",fcfs_queue[0]->name);
            // printf("%d ",fcfs_queue[0]->burst_time);
            // printf("%d ",fcfs_queue[0]->remain_time);
            // printf("fcfs\n");
            gantt_chart_update(gantt_chart, &chart_size, fcfs_queue[0]->name, 1);
            fcfs_queue[0]->burst_time -= 1;
            fcfs_queue[0]->remain_time -= 1;

            if(fcfs_queue[0]->remain_time == 0)
            {
                //dequeue fcfs
